...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__article_edit__ = __webpack_require__(460);
...
var ArticleEditPageModule = (function () {
    function ArticleEditPageModule() {
    }
    ArticleEditPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__article_edit__["a" /* ArticleEditPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__article_edit__["a" /* ArticleEditPage */]),
 ...
 */
var ArticleEditPage = (function () {
    function ArticleEditPage(navCtrl, viewCtrl, navParams, articleProvider, clientProvider) {
    ...
    ArticleEditPage.prototype.assignClientToItem = function (id) {
        var _this = this;
    ...
    ArticleEditPage.prototype.assignClients = function () {
        var _this = this;
    ...
    ArticleEditPage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    ArticleEditPage.prototype.close = function () {
    ...
    ArticleEditPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-article-edit',template:/*ion-inline-start:"/home/tchinda/tutorial/githubpush/Full-starter/appMobileFrontEnd/src/pages/article-edit/article-edit.html"*/'<ion-header>\n\n  <ion-navbar>\n      <ion-title>{{ \'ARTICLE_EDIT_TITLE\' | translate }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-item-group>\n\n      <ion-item-divider sticky>\n          <ion-label>\n              Article edit entry :\n          </ion-label>\n      </ion-item-divider>\n      <ion-item>\n          <ion-label>\n              intitule :\n          </ion-label>\n          <ion-input [(ngModel)]="item.intitule" type="string"></ion-input>\n      </ion-item>\n      <ion-item>\n          <ion-label>\n              nombre :\n          </ion-label>\n        <ion-input [(ngModel)]="item.nombre" type="number"></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>\n          client :\n        </ion-label>\n        <ion-select [(ngModel)]="client_id">\n          <ion-option *ngFor="let itemElt of clients" value="{{itemElt.id || item.client.id}}">{{itemElt.name}}</ion-option>\n        </ion-select>\n      </ion-item>\n  </ion-item-group>\n  <button ion-button block (click)="close()"> Edit </button>\n  <button ion-button block color="danger" (click)="cancel()">Cancel</button>\n\n</ion-content>'/*ion-inline-end:"/home/tchinda/tutorial/githubpush/Full-starter/appMobileFrontEnd/src/pages/article-edit/article-edit.html"*/,
        }),
